...
import com.example.mypractice.adapter.MultiImageAdapter
import com.example.mypractice.databinding.ActivityUserTableBinding
import com.example.mypractice.model.User
    ...
    fun viewAll() {
        ...
        getUserBtn!!.setOnClickListener(View.OnClickListener {
            ...
            while (res.moveToNext()) {
                ...
                val PROFILEURI = res.getString(4)
                user = User(ID,EMAIL,PASSWORD,NAME,PROFILEURI)
                list.add(user)
            }
